...
test('renders all 100 leaderboard users in one embed', () => {
  ...
  assert.match(embeds[0].data.description, /Player\\_1/);
  assert.match(embeds[0].data.description, /Player\\_100/);
  assert.match(embeds[0].data.description, /^\*\*1\. Player\\_1 — 100,000 arrows\*\*/);
  assert.doesNotMatch(embeds[0].data.description, /```|\*\*001\./);
